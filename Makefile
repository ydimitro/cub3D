...
# Folders & files
HEADER = cub3d.h
FILES = destroy direction drawing drawing_utils_texture drawing_utils_2 error_handling init map_check map_get_valid map_parse_utils movement raycasting rendering textures_parse main
LIBFT = -L libft -lft
