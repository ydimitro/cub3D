...
# Folders & files
HEADER = cub3d.h
FILES = main map checking_map parsing parsing_utils errors errors1 errors_utils texure_handling utils init free colors player brezenham raycasting raycasting2 raycasting_utils  wall_colision draw3d sound
LIBFT = -L libft -lft
